...
| 4 Project threads isolated         | Assignment scope and reused-thread rejection                                               | Resolve/contain real workspace paths and SDK resume, Phase 2 |
...
| 9 Explicit durable state           | Typed events, tasks, knowledge and decisions                                               | Append/fsync/replay/crash tests, Phase 1                     |
